...
/*
// Handle life sharing
// Neutral players (attached characters) have no apparent reasons to share life
func (c *Char) lifeOwner() *Char {
	if sys.cfg.Options.Team.LifeShare && (c.teamside == 0 || c.teamside == 1) && c.helperIndex == 0 {
